    ...
    { id: 0, title: '기본 정보 입력', subtitle: '지원할 직무와 회사를 입력하세요' },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          placeholder: '예: 체계적 계획성 덕분에 팀 프로젝트에서 항상 기한 내 완성이라는 결과를 만들어왔습니다.\n이 장점이 있기 때문에 귀사의 복수 캠페인 동시 운영 업무에서 채널별 일정을 충돌 없이 관리하고, 진행 상황을 팀 전체가 공유할 수 있는 구조를 만들어 바로 기여하겠습니다.\n아직 부족한 광고비 데이터 기반 일정 예측은 입사 후 캠페인 데이터를 누적·분석하며 채워, 단순 일정 관리를 넘어 지연 리스크를 사전에 경고하는 데까지 기여를 넓히겠습니다.\n→ "체계적이기 때문에"(장점) → "이 업무를 이렇게"(지금 기여) → "부족한 건 이렇게 채우며 넓힌다"의 흐름입니다.',
          rows: 5, relatedWorkbooks: ['job_analysis', 'experience', 'motivation', 'jobcompetency', 'goalachievement', 'careergoal']
        }
      ]
    },
