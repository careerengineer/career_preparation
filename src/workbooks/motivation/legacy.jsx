...
const MotivationWorkbook = () => {
  ...
  const round1Steps = [
    ...
    { id: 1, title: 'Q1: 왜 이 직무인가', subtitle: '단순 관심을 넘어 가치관·비전·인생 목표와 이 직무의 연결',
      questions: [
        ...
        { id: 'q1_3', label: 'Q1-3. 이 직무에서 성장하면 어떤 일을 하게 되는지 알고 있나요? 그 모습 중 해보고 싶은 것은?', hint: '리서치 기반 — 현직자 인터뷰, 시니어 채용공고 등을 참고하세요', guide: { description: '이 직무의 성장 경로를 이해하고 있다는 것 자체가 강력한 지원 이유가 됩니다.', diagnosis: '즉석자가진단: "3년 후에 어떤 일을 하고 싶어요?"라고 물으면 리서치 기반으로 즉답 가능한가?', helpQuestions: ['시니어 채용공고에서 신입 공고에 없는 항목은?', '현직자 인터뷰에서 "경험이 쌓이면 하게 되는 일"은?', '그 중 해보고 싶은 것과 그 이유는?'], ifDifficult: '시니어 직무상세내용과 신입 직무상세내용을 나란히 놓고 비교해보세요.', ifStillDifficult: '현직자 인터뷰 영상 3편 이상을 보고 공통 성장 경험을 정리해보세요.' }, placeholder: '예: 시니어 마케터는 캠페인 전략 총괄, 브랜드 포지셔닝 설계를 합니다. 저는 특히 데이터와 크리에이티브를 결합해 브랜드 전략을 설계하는 역할에 도달하고 싶습니다.', rows: 4, relatedWorkbooks: ['job_analysis', 'experience', 'jobcompetency', 'personality', 'goalachievement', 'careergoal'] }
      ] },
    { id: 2, title: 'Q2: 왜 이 회사인가', subtitle: '같은 직무를 하는 수많은 회사 중 이 회사여야 하는 이유',
      questions: [
        { id: 'q2_1', label: 'Q2-1. 이 회사만의 차별점은 무엇인가요?', hint: '회사의 직무분석 없이는 쓸 수 없는 구체적 사실 — "좋은 회사라서"는 답이 아닙니다', guide: { description: '"업계 1위", "성장 가능성"은 누구나 씁니다. 다른 회사에 해당 안 되는 사실이어야 합니다.', diagnosis: '즉석자가진단: "다른 회사도 좋은데 왜 여기인가요?"에 명확히 답변 가능한가?', helpQuestions: ['이 회사의 독특한 비즈니스 모델이나 전략은?', '조직 문화나 업무 방식의 특징은?', '최근 1년 이내 주목할 뉴스나 프로젝트는?'], ifDifficult: '회사 홈페이지 뉴스룸, CEO 인터뷰, 보도자료를 확인하세요.', ifStillDifficult: '경쟁사 2곳과 비교해보세요. 비교하면 차별점이 보입니다.' }, placeholder: '예: 귀사는 자체 데이터 플랫폼을 보유해 1st party data 기반 마케팅이 가능합니다. 대부분의 경쟁사가 외부 데이터에 의존하는 반면...', rows: 4, relatedWorkbooks: ['job_analysis', 'jobcompetency', 'personality', 'goalachievement', 'careergoal'] },
        { id: 'q2_2', label: 'Q2-2. 이 회사의 특징이 나의 가치관·비전과 어떻게 연결되나요?', hint: 'Q1의 가치관과 이 회사의 특징이 직접 연결되어야 합니다', guide: { description: '다른 회사가 아닌 이 회사여야 하는 개인적이고 구체적인 이유를 찾으세요.', diagnosis: '즉석자가진단: "구체적인 연결 지점을 하나만 말해주세요"에 즉답 가능한가?', helpQuestions: ['Q1에서 말한 가치관이 이 회사에서 어떻게 실현되나요?', '이 회사의 방향성이 나의 성장 방향과 맞는 이유는?', '경쟁사가 아닌 이 회사를 선택한 결정적 이유 하나는?'], ifDifficult: '자신의 가치관을 먼저 정리한 후 회사 특징과의 교집합을 찾아보세요.', ifStillDifficult: '이 회사에서 일하는 자신을 상상해보세요. 다른 회사에서는 느낄 수 없는 것은?' }, placeholder: '예: "데이터로 고객의 선택을 이해하고 싶다"는 제 목표는 귀사의 1st party data 환경에서 가장 직접적으로 실현될 수 있습니다.', rows: 4, relatedWorkbooks: ['job_analysis', 'career_roadmap', 'jobcompetency', 'personality', 'goalachievement', 'careergoal'] }
      ] },
    { id: 3, title: 'Q3: 무엇을 왜 준비했는가', subtitle: '동기를 위해 준비한 역량과 그 목적 — 방향성 있는 준비의 증거',
      questions: [
        { id: 'q3_1', label: 'Q3-1. 이 직무에 필요하다고 판단한 역량은 무엇이고, 왜 그렇게 판단했나요?', hint: '"~하기 위해 ~이 필요하다고 판단했다" — 목적이 드러나야 합니다', guide: { description: '역량 나열이 아닌 왜 그 역량이 필요한지 이유가 있어야 합니다.', diagnosis: '즉석자가진단: "왜 그 역량을 준비했나요?"에 직무와 연결해 즉답 가능한가?', helpQuestions: ['채용공고에서 강조하는 역량은?', '현직자가 "이게 없으면 힘들다"고 한 것은?', '그 역량이 없으면 어떤 문제가 생기나요?'], ifDifficult: 'Q1-3 성장 경로에서 필요 역량을 역산해보세요.', ifStillDifficult: '채용공고 자격요건과 우대사항을 분리해 각각 왜 필요한지 써보세요.' }, placeholder: '예: 고객 행동 데이터를 직접 다루려면 SQL이 필수이고, 캠페인 성과를 측정하려면 GA가 필요하다고 판단했습니다.', rows: 4, relatedWorkbooks: ['job_analysis', 'jobcompetency', 'personality', 'goalachievement', 'careergoal'] },
        { id: 'q3_2', label: 'Q3-2. 그 역량을 위해 어떤 준비를 했나요?', hint: '"그냥 했다"가 아닌, 이 직무를 향한 방향성 있는 선택이어야 합니다', guide: { description: '스펙 쌓기가 아닌 "하고 싶은 일을 위해 의도적으로 준비한 것"이어야 합니다.', diagnosis: '즉석자가진단: 각 활동의 이유가 이 직무를 향한 동기와 연결되나요?', helpQuestions: ['각 활동을 시작한 직접적인 계기는?', '기대한 것과 실제로 얻은 것은?', '이 활동이 없었다면 나는 어떻게 달랐을까?'], ifDifficult: '이유 없는 활동은 과감하게 빼세요. 이유 있는 것만 남기세요.', ifStillDifficult: '가장 의미 있었던 활동 하나를 STAR 방식으로 깊게 써보세요.' }, placeholder: '예: SQL 강의 → 고객 데이터 직접 추출 필요. GA 자격증 → 웹 행동 데이터 체계적 학습. SNS 프로젝트 → A/B 테스트 직접 설계 경험.', rows: 4, relatedWorkbooks: ['experience', 'career_roadmap', 'jobcompetency', 'personality', 'goalachievement', 'careergoal'] },
        { id: 'q3_3', label: 'Q3-3. 준비한 역량이 이 회사의 어떤 업무에서 어떻게 쓰일 수 있나요?', hint: '역량과 직무 업무를 1:1로 연결하는 연습', guide: { description: '이 연결이 없으면 Q4(기여)를 쓸 수 없습니다. 채용공고 주요 업무를 열어두고 작성하세요.', diagnosis: '즉석자가진단: "이 역량이 없었다면 이 업무를 할 수 없었을까요?"에 "예"라고 답할 수 있나요?', helpQuestions: ['채용공고의 주요 업무 목록을 확인했나요?', '내 역량 중 그 업무에 직접 연결되는 것은?', '연결이 안 되는 역량은 굳이 언급 불필요'], ifDifficult: '"이 역량이 있어서 이 업무의 이 부분을 할 수 있다"로 써보세요.', ifStillDifficult: '채용공고 주요 업무 3가지를 적고, 각각에 연결되는 내 역량을 옆에 쓰세요.' }, placeholder: '예: SQL → "고객 행동 데이터 분석" 업무. GA → "채널별 퍼포먼스 측정" 업무. A/B 테스트 → "마케팅 실험 설계" 업무.', rows: 4, relatedWorkbooks: ['job_analysis', 'experience', 'jobcompetency', 'personality', 'goalachievement', 'careergoal'] }
      ] },
    { id: 4, title: 'Q4: 어떻게 기여할 수 있는가', subtitle: 'Q1~Q3의 자연스러운 결론 — 동기와 준비가 기여로 이어지는 논리',
      questions: [
        { id: 'q4_1', label: 'Q4-1. 동기와 역량이 이 회사에서 어떻게 기여로 이어지나요?', hint: '"열심히 하겠습니다"가 아닌 ①직무와 연결 ②지금 역량으로 할 수 있는 일 ③부족한 역량을 채우며 기여하는 그림', guide: { description: '세 가지를 모두 담으세요. (1) 직무·주요 업무와 최대한 구체적으로 연결하고, (2) 지금 가진 역량으로 당장 무엇을 할 수 있는지 말한 뒤, (3) 아직 부족한 역량은 어떻게 확보하면서 기여를 키워갈지까지 쓰면 "성장 가능성 있는 즉시 전력"으로 읽힙니다.', diagnosis: '즉석자가진단: "지금 당장 할 수 있는 것"과 "채워가며 할 것"을 구분해서 말할 수 있나요?', helpQuestions: ['채용공고의 주요 업무 중 내 역량과 직접 연결되는 것은?', '지금 가진 역량으로 입사 직후 바로 할 수 있는 일은?', '아직 부족한 역량은 무엇이고, 일하면서 어떻게(방법·기간) 확보할 건가요?'], ifDifficult: '"지금은 ~로 ~에 기여하고, ~은 ~하면서 채워 ~까지 해내겠다"로 두 단계로 나눠 써보세요.', ifStillDifficult: '"당장 할 수 있는 것" 한 문장 + "부족한 것을 채우며 할 것" 한 문장을 따로 쓴 뒤 이어 붙이세요.' }, placeholder: '예: 데이터로 고객의 선택을 이해하고 싶다는 동기로 SQL과 GA를 익혔기에, 입사 직후 귀사의 고객 행동 데이터를 직접 추출·분석해 캠페인 타겟을 정교화하는 일에 바로 기여할 수 있습니다. 아직 부족한 머신러닝 기반 예측 모델링은 현재 수강 중인 강의와 사내 데이터 실무를 병행하며 6개월 내 채워, 단순 분석을 넘어 고객 이탈 예측까지 맡을 수 있도록 기여 범위를 넓혀가겠습니다.', rows: 5, relatedWorkbooks: ['self_introduction', 'jobcompetency', 'personality', 'goalachievement', 'careergoal'] },
        { id: 'q4_2', label: 'Q4-2. 이 회사가 지금 집중하는 과제와 내 기여가 어떻게 연결되나요?', hint: 'Q2 리서치 결과와 Q3 역량을 연결 — 지금 할 수 있는 일 + 부족한 역량을 채우며 키워갈 기여까지', guide: { description: '"이 회사의 이 과제에 내 역량이 이렇게 연결된다"에 더해, 지금 바로 보탤 수 있는 부분과 아직 부족해 채워가야 할 부분을 함께 보여주면 기여 논리가 완성됩니다.', diagnosis: '즉석자가진단: "다른 회사에서도 이 기여가 가능했을까요?"에 "아니요"가 나와야 합니다.', helpQuestions: ['Q2에서 파악한 이 회사의 과제를 하나 적으세요', '그 과제에서 지금 내 역량으로 바로 할 수 있는 부분은?', '그 과제에 필요하지만 아직 부족한 역량은 어떻게 채워갈 건가요?'], ifDifficult: '"이 과제에서 지금은 ~까지 기여하고, ~을 채우며 ~까지 맡겠다"로 써보세요.', ifStillDifficult: '최근 뉴스 하나를 골라 내 역량과의 접점, 그리고 보완할 점을 함께 찾아보세요.' }, placeholder: '예: 귀사의 개인화 추천 시스템 고도화 과정에서, 지금은 고객 행동 세그먼트를 정교화하는 데이터 분석으로 바로 기여하고, 부족한 추천 알고리즘 이해는 관련 논문 스터디와 실무를 병행해 채우며 추천 로직 개선 제안까지 기여 범위를 넓혀가겠습니다.', rows: 5, relatedWorkbooks: ['job_analysis', 'experience', 'jobcompetency', 'personality', 'goalachievement', 'careergoal'] }
      ] }
  ];
  ...
  const round2Questions = {
    ...
    2: [
      { id: 'q2_2_1', label: 'Q2 심화-1. 경쟁사 2곳과 비교했을 때 장단점은? 그래도 선택한 이유는?', hint: '객관적 비교를 통해 선택 이유를 강화', guide: { description: '비교를 통해 "왜 하필 이 회사"인지 더 명확해집니다.', diagnosis: '즉석자가진단: "경쟁사도 좋은데 왜 여기?"에 명확히 답변 가능한가?', helpQuestions: ['경쟁사 A, B의 각각 강점은?', '이 회사의 단점은?', '그럼에도 선택한 결정적 이유는?'], ifDifficult: '시장점유율, 문화, 성장 기회 등으로 비교하세요.', ifStillDifficult: '"큰 회사에서 보조" vs "작은 회사에서 직접" 같은 구조적 차이를 찾으세요.' }, placeholder: '예: A사는 규모 크지만 신입은 보조 역할만. 이 회사는 신입부터 실제 데이터와 실험 참여 가능. "직접 설계하고 실행하는 것"이 내 성장에 더 맞습니다.', rows: 4, relatedWorkbooks: ['job_analysis', 'experience', 'jobcompetency', 'personality', 'goalachievement', 'careergoal'] },
      { id: 'q2_2_2', label: 'Q2 심화-2. 이 회사가 직면한 도전 과제는? 거기에 내가 어떻게 연결되나요?', hint: '회사의 현재 과제를 파악하고 내 역량과 연결 — Q4 기여 논리의 토대', guide: { description: '도전 과제를 파악하고 있다는 것은 진지하게 직무분석 했다는 증거입니다.', diagnosis: '즉석자가진단: "이 회사가 지금 가장 어려운 부분은?"에 구체적으로 답할 수 있는가?', helpQuestions: ['업계 트렌드에서 이 회사가 대응해야 할 변화는?', 'CEO 인터뷰에서 강조한 방향은?', '그 과제 중 내 역량과 연결되는 것은?'], ifDifficult: '회사 홈페이지 뉴스룸에서 최근 6개월 기사를 훑어보세요.', ifStillDifficult: '업계 전체 트렌드와 이 회사를 연결해도 좋습니다.' }, placeholder: '예: [도전 과제] MZ세대 고객 확보 + 데이터 마케팅 고도화. [연결] MZ세대인 저는 또래 소비 심리를 데이터로 검증하는 시각이 있고, SQL·GA 역량이 이 방향과 일치합니다.', rows: 4, relatedWorkbooks: ['job_analysis', 'experience', 'jobcompetency', 'personality', 'goalachievement', 'careergoal'] }
    ],
    3: [
      { id: 'q2_3_1', label: 'Q3 심화-1. 활동을 모두 나열하고 각각 "왜 했는지" 한 줄씩 써보세요.', hint: '"그냥 했다", "스펙 때문에"는 답이 아닙니다', guide: { description: '활동마다 진짜 이유를 찾는 것이 Q3의 핵심입니다.', diagnosis: '즉석자가진단: 각 활동 이유가 직무 동기와 연결되나요?', helpQuestions: ['시작 계기가 무엇이었나요?', '기대한 것은? 실제 얻은 것은?', '이유 없는 활동은 과감히 빼세요'], ifDifficult: '이유 있는 활동만 남기고 직무 연결 3개로 줄여보세요.', ifStillDifficult: '"이 활동이 없었다면 나는 어떻게 달랐을까?"로 역추적하세요.' }, placeholder: '예: SQL → 고객 데이터 직접 추출 필요. GA 자격증 → 체계적 학습. 마케팅 동아리 → 실제 캠페인 경험. 토익(삭제) → 직무 연관 없음.', rows: 4, relatedWorkbooks: ['experience', 'self_introduction', 'jobcompetency', 'personality', 'goalachievement', 'careergoal'] },
      { id: 'q2_3_2', label: 'Q3 심화-2. 가장 의미 있었던 활동 하나를 STAR 방식으로 써보세요.', hint: '하나를 깊게 쓰는 것 > 여러 개를 얕게 나열', guide: { description: 'S(상황) → T(과제) → A(행동) → R(결과) + 배운 것으로 깊게 쓰세요.', diagnosis: '즉석자가진단: "그 경험에서 배운 것이 이 직무와 어떻게 연결?"에 즉답 가능?', helpQuestions: ['S: 언제, 어디서?', 'T: 맡은 역할/문제는?', 'A: 구체적으로 무엇을 어떻게?', 'R: 숫자 결과는?'], ifDifficult: '숫자 없어도 "어떤 변화가 있었는지" 구체적으로 쓸 수 있습니다.', ifStillDifficult: '배운 것이 직무 선택 이유와 어떻게 연결되는지까지 써보세요.' }, placeholder: '예: S: SNS 프로젝트 콘텐츠 기획. T: 3개월 팔로워 1,000명. A: 매주 A/B 테스트. R: 클릭률 1.8배, 팔로워 1,200명. 배운 것: 감이 아닌 데이터로 개선 가능.', rows: 5, relatedWorkbooks: ['experience', 'jobcompetency', 'personality', 'goalachievement', 'careergoal'] },
      { id: 'q2_3_3', label: 'Q3 심화-3. 현재 준비 상태를 솔직하게 평가하세요. 갖춘 것과 부족한 것은?', hint: '부족한 부분을 인정하는 것이 오히려 진정성을 높입니다', guide: { description: '갖춘 것과 부족한 것을 명확히 구분하고 보완 계획을 함께 제시하세요.', diagnosis: '즉석자가진단: "부족한 역량을 어떻게 채울 건가요?"에 구체적 계획 즉답?', helpQuestions: ['증거 있는 역량만 "갖췄다"고 쓰세요', '부족한 역량의 보완 계획은?', '이미 시작한 것이 있나요?'], ifDifficult: '역량 목록을 "충분/기초/부족"으로 분류해보세요.', ifStillDifficult: '"열심히 배우겠습니다"는 계획이 아닙니다. 구체적 방법+기간이 필요합니다.' }, placeholder: '예: SQL 기초, GA 자격증. Python 기초 수준. 유료 광고 집행 경험 없음. [보완] Python: 강의 수강 중. 유료 광고: 입사 전 소액 집행 예정.', rows: 5, relatedWorkbooks: ['experience', 'jobcompetency', 'personality', 'goalachievement', 'careergoal'] }
    ],
    4: [
      { id: 'q2_4_1', label: 'Q4 심화-1. Q1(동기) → Q3(역량) → Q4(기여)를 한 문장으로 연결해보세요.', hint: '"[동기] 때문에 [역량]을 준비했고, 그래서 [기여]가 가능하다"', guide: { description: '이 세 가지가 인과관계로 연결될 때 Q4가 완성됩니다.', diagnosis: '즉석자가진단: 연결 문장 후 "그래서 왜요?"에 막히지 않나요?', helpQuestions: ['Q1 동기 (핵심 한 문장):', 'Q3 역량 (가장 연결되는 것):', '이 역량이 어떤 업무에서 어떻게?'], ifDifficult: '"~기 때문에 ~을 준비했고, 따라서 ~할 수 있다"로 연결.', ifStillDifficult: '동기·역량·기여를 각 한 문장으로 쓴 뒤 이어 붙이세요.' }, placeholder: '예: "데이터로 고객의 선택을 이해하고 싶다" → SQL+GA 학습 → 귀사의 고객 행동 데이터 분석 업무에 즉시 기여 가능.', rows: 5, relatedWorkbooks: ['self_introduction', 'jobcompetency', 'personality', 'goalachievement', 'careergoal'] },
      { id: 'q2_4_2', label: 'Q4 심화-2. 이 회사가 집중하는 과제 하나를 골라 내 기여를 연결해보세요.', hint: 'Q2 리서치와 Q3 역량을 연결 — 구체적인 지점', guide: { description: '"이 과제에 내 역량이 이렇게 연결"이 보이면 기여 논리 완성입니다.', diagnosis: '즉석자가진단: "다른 회사에서도 가능했을까요?"에 "아니요"가 나와야 합니다.', helpQuestions: ['Q2에서 파악한 과제 하나를 적으세요', '그 과제에 필요한 역량은?', '내 역량과 어떻게 겹치나요?'], ifDifficult: '최근 뉴스 하나를 골라 내 역량과의 접점을 찾아보세요.', ifStillDifficult: '"이 회사에서 이 역량이 특히 필요한 이유" 하나만 찾아도 됩니다.' }, placeholder: '예: [과제] AI 개인화 추천 고도화. [역량] SQL+GA. → "귀사의 개인화 추천 고도화에서 고객 세그먼트를 정교화하는 분석으로 기여할 수 있습니다."', rows: 5, relatedWorkbooks: ['job_analysis', 'jobcompetency', 'personality', 'goalachievement', 'careergoal'] }
    ]
  };
  ...
  const round3Questions = [
    { id: 'connect_q1q2', label: '연결 Q1→Q2: 왜 이 직무 → 왜 이 회사', hint: '"이 직무를 할 수 있는 곳은 많지만, 귀사를 선택한 이유는..."', placeholder: '예: 데이터로 고객의 선택을 설계하고 싶다는 확신이 생긴 이후, 이 일을 가장 잘 할 수 있는 환경을 찾았습니다. 귀사는 1st party data 기반 마케팅이 가능한 몇 안 되는 회사이고, 신입부터 실제 데이터와 실험에 참여할 수 있는 환경이 저의 성장 방향과 가장 잘 맞습니다.', rows: 5, referenceQuestions: ['q1_1', 'q1_2', 'q2_1', 'q2_2'] },
    { id: 'connect_q2q3', label: '연결 Q2→Q3: 왜 이 회사 → 무엇을 준비했는가', hint: '"그 확신이 생긴 이후부터 본격적으로 준비를 시작했습니다..."', placeholder: '예: 귀사에서 데이터 기반 마케팅을 하기 위해 고객 행동 데이터를 직접 다루는 역량이 필수라고 판단했습니다. SQL로 데이터를 직접 추출하고, GA로 웹 행동 데이터를 분석하고, SNS 프로젝트에서 A/B 테스트를 직접 설계하며 "감이 아닌 근거"로 마케팅하는 경험을 쌓았습니다.', rows: 5, referenceQuestions: ['q2_1', 'q2_2', 'q3_1', 'q3_2'] },
    { id: 'connect_q3q4', label: '연결 Q3→Q4: 준비한 역량 → 기여의 결론', hint: '"이렇게 준비해온 역량이 귀사에서 이런 방식으로..."', placeholder: '예: 이렇게 쌓아온 데이터 분석 역량은 귀사의 "고객 행동 데이터 분석" 업무에 즉시 활용됩니다. 개인화 추천 시스템 고도화라는 과제에서 고객 세그먼트를 정교화하는 분석으로 직접 기여할 수 있다고 생각하기 때문에 지원했습니다.', rows: 5, referenceQuestions: ['q3_2', 'q3_3', 'q4_1', 'q4_2'] }
  ];
