...
const MotivationWorkbook = () => {
  ...
  const round2Questions = {
    1: [
      { id: 'q2_1_1', label: 'Q1 심화-1. 현직자 인터뷰 3편 이상에서 공통적으로 강조하는 것은?', hint: '회사의 직무분석 없이는 쓸 수 없는 내용이어야 합니다', guide: { description: '현직자들이 공통적으로 말하는 것이 채용공고에 없는 진짜 핵심입니다.', diagnosis: '즉석자가진단: 현직자 3명이 공통으로 언급한 역량을 하나 이상 찾았나요?', helpQuestions: ['"[직무명] 현직자 인터뷰"로 검색', '"이게 없으면 힘들더라"고 한 것은?', '"처음엔 몰랐는데 꼭 필요하더라"는?'], ifDifficult: '직무분석에 30분만 투자하면 채용공고에서 못 찾는 인사이트를 얻습니다.', ifStillDifficult: '채용공고 분석 가이드워크북에서 직무별 핵심 키워드를 정리하는 단계별 방법을 확인하세요.' }, placeholder: '예: 현직 기구 설계 엔지니어 5편을 보니 공통적으로 "CAD 숙련도보다 양산성과 공차를 함께 고려하는 설계 사고가 더 중요하다"고 했습니다.', rows: 4, relatedWorkbooks: ['job_analysis', 'jobcompetency', 'personality', 'goalachievement', 'careergoal'] },
      { id: 'q2_1_2', label: 'Q1 심화-2. 비슷한 다른 직무 2개와 비교했을 때, 왜 하필 이 직무인가요?', hint: '비교를 통해 "이 직무에서만 중요한 이유"가 드러납니다', guide: { description: '비슷한 직무와 비교하면 "왜 하필 이 직무"인지가 명확해집니다.', diagnosis: '즉석자가진단: "다른 직무에서도 하지 않나요?"에 즉답 가능한가?', helpQuestions: ['비슷한 직무 2개의 핵심 역량을 비교', '이 직무에서만 특별히 중요한 이유는?', '이 역량 없이 대체 가능한가요?'], ifDifficult: '각 직무 채용공고를 나란히 놓고 비교하세요.', ifStillDifficult: '"이 직무에서 유독 중요한 상황"을 하나 떠올려보세요.' }, placeholder: '예: 생산기술은 공정 안정화, 품질은 검증이 핵심. 기구 설계는 "요구 기능을 부품 형상과 공차로 구현해 양산까지 이어지게 하는 것"이 핵심인데, 이것이 제 가치관과 가장 잘 맞습니다.', rows: 4, relatedWorkbooks: ['job_analysis', 'experience', 'jobcompetency', 'personality', 'goalachievement', 'careergoal'] },
      { id: 'q2_1_3', label: 'Q1 심화-3. 이 직무가 없었다면 이 가치를 어떻게 실현했을까요?', hint: '이 직무가 대체 불가능한 이유를 보여주는 질문', guide: { description: '"다른 방법으로도 가능하다"면 이 직무를 선택한 이유가 약해집니다.', diagnosis: '즉석자가진단: "다른 직무에서도 가능하지 않나요?"에 즉답 가능한가?', helpQuestions: ['다른 방법으로 같은 가치를 실현할 수 있나요?', '그래도 이 직무를 선택한 이유는?', '이 직무만이 줄 수 있는 고유한 경험은?'], ifDifficult: '이 직무를 하는 순간이 가장 몰입되는 이유를 떠올려보세요.', ifStillDifficult: '이 직무를 평생 해야 한다면 기꺼이 할 수 있나요? 그 이유가 핵심입니다.' }, placeholder: '예: 해석 전문 직무에서도 구조 검토는 하지만 "형상을 직접 설계"하지는 않습니다. "기능 정의부터 양산 형상까지 일관되게 책임지는 과정"은 기구 설계에서만 가능합니다.', rows: 4, relatedWorkbooks: ['job_analysis', 'career_roadmap', 'jobcompetency', 'personality', 'goalachievement', 'careergoal'] }
    ],
    2: [
      { id: 'q2_2_1', label: 'Q2 심화-1. 경쟁사 2곳과 비교했을 때 장단점은? 그래도 선택한 이유는?', hint: '객관적 비교를 통해 선택 이유를 강화', guide: { description: '비교를 통해 "왜 하필 이 회사"인지 더 명확해집니다.', diagnosis: '즉석자가진단: "경쟁사도 좋은데 왜 여기?"에 명확히 답변 가능한가?', helpQuestions: ['경쟁사 A, B의 각각 강점은?', '이 회사의 단점은?', '그럼에도 선택한 결정적 이유는?'], ifDifficult: '시장점유율, 문화, 성장 기회 등으로 비교하세요.', ifStillDifficult: '"큰 회사에서 보조" vs "작은 회사에서 직접" 같은 구조적 차이를 찾으세요.' }, placeholder: '예: A사는 규모 크지만 신입은 설계 보조 역할만. 이 회사는 신입부터 부품 설계와 시제품 검증에 직접 참여 가능. "직접 설계하고 양산까지 확인하는 것"이 내 성장에 더 맞습니다.', rows: 4, relatedWorkbooks: ['job_analysis', 'experience', 'jobcompetency', 'personality', 'goalachievement', 'careergoal'] },
      { id: 'q2_2_2', label: 'Q2 심화-2. 이 회사가 직면한 도전 과제는? 거기에 내가 어떻게 연결되나요?', hint: '회사의 현재 과제를 파악하고 내 역량과 연결 — Q4 기여 논리의 토대', guide: { description: '도전 과제를 파악하고 있다는 것은 진지하게 직무분석 했다는 증거입니다.', diagnosis: '즉석자가진단: "이 회사가 지금 가장 어려운 부분은?"에 구체적으로 답할 수 있는가?', helpQuestions: ['업계 트렌드에서 이 회사가 대응해야 할 변화는?', 'CEO 인터뷰에서 강조한 방향은?', '그 과제 중 내 역량과 연결되는 것은?'], ifDifficult: '회사 홈페이지 뉴스룸에서 최근 6개월 기사를 훑어보세요.', ifStillDifficult: '업계 전체 트렌드와 이 회사를 연결해도 좋습니다.' }, placeholder: '예: [도전 과제] 제품 경량화 + 원가 절감. [연결] 저는 캡스톤에서 부품 형상 재설계로 무게를 줄여본 경험이 있고, CAD 설계·공차 분석 역량이 이 방향과 일치합니다.', rows: 4, relatedWorkbooks: ['job_analysis', 'experience', 'jobcompetency', 'personality', 'goalachievement', 'careergoal'] }
    ],
    3: [
      { id: 'q2_3_1', label: 'Q3 심화-1. 활동을 모두 나열하고 각각 "왜 했는지" 한 줄씩 써보세요.', hint: '"그냥 했다", "스펙 때문에"는 답이 아닙니다', guide: { description: '활동마다 진짜 이유를 찾는 것이 Q3의 핵심입니다.', diagnosis: '즉석자가진단: 각 활동 이유가 직무 동기와 연결되나요?', helpQuestions: ['시작 계기가 무엇이었나요?', '기대한 것은? 실제 얻은 것은?', '이유 없는 활동은 과감히 빼세요'], ifDifficult: '이유 있는 활동만 남기고 직무 연결 3개로 줄여보세요.', ifStillDifficult: '"이 활동이 없었다면 나는 어떻게 달랐을까?"로 역추적하세요.' }, placeholder: '예: SolidWorks → 기구 부품 직접 모델링 필요. 공차 분석 강의 → 체계적 학습. 자작자동차 동아리 → 실제 부품 설계·가공 경험. 토익(삭제) → 직무 연관 없음.', rows: 4, relatedWorkbooks: ['experience', 'self_introduction', 'jobcompetency', 'personality', 'goalachievement', 'careergoal'] },
      { id: 'q2_3_2', label: 'Q3 심화-2. 가장 의미 있었던 활동 하나를 STAR 방식으로 써보세요.', hint: '하나를 깊게 쓰는 것 > 여러 개를 얕게 나열', guide: { description: 'S(상황) → T(과제) → A(행동) → R(결과) + 배운 것으로 깊게 쓰세요.', diagnosis: '즉석자가진단: "그 경험에서 배운 것이 이 직무와 어떻게 연결?"에 즉답 가능?', helpQuestions: ['S: 언제, 어디서?', 'T: 맡은 역할/문제는?', 'A: 구체적으로 무엇을 어떻게?', 'R: 숫자 결과는?'], ifDifficult: '숫자 없어도 "어떤 변화가 있었는지" 구체적으로 쓸 수 있습니다.', ifStillDifficult: '배운 것이 직무 선택 이유와 어떻게 연결되는지까지 써보세요.' }, placeholder: '예: S: 자작자동차 동아리 브래킷 조립 불량. T: 3개월 내 조립 불량률 절감. A: 공차 누적을 재분석해 결합부 공차를 재설계. R: 시제품 불량률 30% 감소, 재작업 시간 단축. 배운 것: 감이 아닌 공차 분석으로 개선 가능.', rows: 5, relatedWorkbooks: ['experience', 'jobcompetency', 'personality', 'goalachievement', 'careergoal'] },
      { id: 'q2_3_3', label: 'Q3 심화-3. 현재 준비 상태를 솔직하게 평가하세요. 갖춘 것과 부족한 것은?', hint: '부족한 부분을 인정하는 것이 오히려 진정성을 높입니다', guide: { description: '갖춘 것과 부족한 것을 명확히 구분하고 보완 계획을 함께 제시하세요.', diagnosis: '즉석자가진단: "부족한 역량을 어떻게 채울 건가요?"에 구체적 계획 즉답?', helpQuestions: ['증거 있는 역량만 "갖췄다"고 쓰세요', '부족한 역량의 보완 계획은?', '이미 시작한 것이 있나요?'], ifDifficult: '역량 목록을 "충분/기초/부족"으로 분류해보세요.', ifStillDifficult: '"열심히 배우겠습니다"는 계획이 아닙니다. 구체적 방법+기간이 필요합니다.' }, placeholder: '예: SolidWorks 활용 가능, 공차 분석 기초. FEA 구조해석 기초 수준. 사출/금형 설계 경험 없음. [보완] FEA: 강의 수강 중. 사출 설계: 입사 전 관련 도서·온라인 강의 학습 예정.', rows: 5, relatedWorkbooks: ['experience', 'jobcompetency', 'personality', 'goalachievement', 'careergoal'] }
    ],
    4: [
      { id: 'q2_4_1', label: 'Q4 심화-1. Q1(동기) → Q3(역량) → Q4(기여)를 한 문장으로 연결해보세요.', hint: '"[동기] 때문에 [역량]을 준비했고, 그래서 [기여]가 가능하다"', guide: { description: '이 세 가지가 인과관계로 연결될 때 Q4가 완성됩니다.', diagnosis: '즉석자가진단: 연결 문장 후 "그래서 왜요?"에 막히지 않나요?', helpQuestions: ['Q1 동기 (핵심 한 문장):', 'Q3 역량 (가장 연결되는 것):', '이 역량이 어떤 업무에서 어떻게?'], ifDifficult: '"~기 때문에 ~을 준비했고, 따라서 ~할 수 있다"로 연결.', ifStillDifficult: '동기·역량·기여를 각 한 문장으로 쓴 뒤 이어 붙이세요.' }, placeholder: '예: "설계한 기구가 양산까지 문제없이 이어지게 하고 싶다" → SolidWorks+공차 분석 학습 → 귀사의 기구 부품 설계·조립 공차 검토 업무에 즉시 기여 가능.', rows: 5, relatedWorkbooks: ['self_introduction', 'jobcompetency', 'personality', 'goalachievement', 'careergoal'] },
      { id: 'q2_4_2', label: 'Q4 심화-2. 이 회사가 집중하는 과제 하나를 골라 내 기여를 연결해보세요.', hint: 'Q2 리서치와 Q3 역량을 연결 — 구체적인 지점', guide: { description: '"이 과제에 내 역량이 이렇게 연결"이 보이면 기여 논리 완성입니다.', diagnosis: '즉석자가진단: "다른 회사에서도 가능했을까요?"에 "아니요"가 나와야 합니다.', helpQuestions: ['Q2에서 파악한 과제 하나를 적으세요', '그 과제에 필요한 역량은?', '내 역량과 어떻게 겹치나요?'], ifDifficult: '최근 뉴스 하나를 골라 내 역량과의 접점을 찾아보세요.', ifStillDifficult: '"이 회사에서 이 역량이 특히 필요한 이유" 하나만 찾아도 됩니다.' }, placeholder: '예: [과제] 제품 경량화. [역량] CAD 설계+공차 분석. → "귀사의 경량화 과제에서 부품 형상을 재설계해 무게를 줄이는 기구 설계로 기여할 수 있습니다."', rows: 5, relatedWorkbooks: ['job_analysis', 'jobcompetency', 'personality', 'goalachievement', 'careergoal'] }
    ]
  };
  ...
  const round3Questions = [
    { id: 'connect_q1q2', label: '연결 Q1→Q2: 왜 이 직무 → 왜 이 회사', hint: '"이 직무를 할 수 있는 곳은 많지만, 귀사를 선택한 이유는..."', placeholder: '예: 설계한 기구가 양산까지 문제없이 이어지게 만들고 싶다는 확신이 생긴 이후, 이 일을 가장 잘 할 수 있는 환경을 찾았습니다. 귀사는 설계·금형·양산을 한 라인에서 운영하는 몇 안 되는 회사이고, 신입부터 부품 설계와 시제품 검증에 직접 참여할 수 있는 환경이 저의 성장 방향과 가장 잘 맞습니다.', rows: 5, referenceQuestions: ['q1_1', 'q1_2', 'q2_1', 'q2_2'] },
    { id: 'connect_q2q3', label: '연결 Q2→Q3: 왜 이 회사 → 무엇을 준비했는가', hint: '"그 확신이 생긴 이후부터 본격적으로 준비를 시작했습니다..."', placeholder: '예: 귀사에서 양산성 있는 기구 설계를 하려면 부품을 직접 모델링하고 공차를 다루는 역량이 필수라고 판단했습니다. SolidWorks로 부품을 직접 설계하고, 공차 분석으로 조립 간섭을 검토하고, 자작자동차 동아리에서 시제품 제작·검증을 직접 수행하며 "감이 아닌 근거"로 설계하는 경험을 쌓았습니다.', rows: 5, referenceQuestions: ['q2_1', 'q2_2', 'q3_1', 'q3_2'] },
    { id: 'connect_q3q4', label: '연결 Q3→Q4: 준비한 역량 → 기여의 결론', hint: '"이렇게 준비해온 역량이 귀사에서 이런 방식으로..."', placeholder: '예: 이렇게 쌓아온 CAD 설계·공차 분석 역량은 귀사의 "기구 부품 설계 및 조립 공차 검토" 업무에 즉시 활용됩니다. 제품 경량화라는 과제에서 부품 형상을 재설계해 무게를 줄이는 설계로 직접 기여할 수 있다고 생각하기 때문에 지원했습니다.', rows: 5, referenceQuestions: ['q3_2', 'q3_3', 'q4_1', 'q4_2'] }
  ];
