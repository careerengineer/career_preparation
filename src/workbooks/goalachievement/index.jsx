...
const LEGACY_KEY = "careerengineer_goalachievement_v1";
const WORKBOOK_KEY = "goalachievement";
...
export default function GoalachievementPage() {
  return (
    <WorkbookShell
      workbookKey="goalachievement"
      mentoringType="cover_letter"
      topReferenceIds={["motivation","jobcompetency","personality","careergoal","self_introduction"]}
    >
      <Bridge />
    </WorkbookShell>
  );
