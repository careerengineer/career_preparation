...
const NewInterviewWorkbook = () => {
  ...
  const downloadFinal = async () => {
    try {
      ...
      const children = buildInterviewDocxChildren({ title: '신 입 면 접 답변집', questions: QUESTIONS, basicInfo, answers, finalText, mentoringLinks: [['신입 면접 준비 가이드북','https://www.latpeed.com/products/H7UHo'],['면접 유형별 답변 전략','https://www.latpeed.com/products/O-KKc'],['면접 멘토링 — 모의 면접과 실전 피드백','https://www.latpeed.com/products/tZ5xw'],['CareerEngineer 카카오톡 상담','https://open.kakao.com/me/careerengineer']] }, docxLib);
