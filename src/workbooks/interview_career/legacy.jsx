...
const CareerInterviewWorkbook = () => {
  ...
  const downloadFinal = async () => {
    try {
      ...
      const children = buildInterviewDocxChildren({ title: '경 력 면 접 답변집', questions: QUESTIONS, basicInfo, answers, finalText, mentoringLinks: [['경력 면접 준비 가이드북','https://www.latpeed.com/products/j3RfY'],['면접 유형별 답변 전략','https://www.latpeed.com/products/O-KKc'],['면접 멘토링 — 모의 면접과 실전 피드백','https://www.latpeed.com/products/tZ5xw'],['이직 컨설팅','https://www.latpeed.com/products/LimF9']] }, docxLib);
