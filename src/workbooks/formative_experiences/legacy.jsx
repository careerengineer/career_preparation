...
const FormativeExperiencesWorkbook = () => {
      ...
      questions: [
        {
          ...
          placeholder: '예: 저의 핵심 가치관은 "약속한 것은 결과까지 책임진다"입니다.\n— 단순히 "성실합니다"가 아니라, 한 번 시작한 일은 결과가 좋든 나쁘든 마지막 보고까지 완결하는 것을 의미합니다.\n— 흥미가 떨어져도, 더 좋은 기회가 생겨도, 처음 약속한 팀에게 마무리 보고를 한 뒤에야 다음으로 옮깁니다.\n— 학과 동기들도 "쟤한테 부탁하면 결과를 본다"고 말하고, 4년 동안 팀 프로젝트에서 늘 자료 정리·최종 산출물 마감 역할이 자연스럽게 저에게 돌아왔습니다.\n— 이 가치관은 대학 1학년 학과 행사 운영 경험 이후 명확한 행동 기준으로 자리잡았고, 이후 학업·대외활동·인턴십을 거치며 신뢰의 기반이 되었습니다.',
        ...
        },
        {
          ...
          placeholder: '예:\n[형성 사건 — 누가 봐도 그럴만한 계기]\n대학 1학년 2학기, 학과 신입생 환영회 운영팀에 들어갔습니다. 행사 일주일 전 운영팀장이 갑작스러운 가족 사정으로 빠지게 되었고, 남은 운영진 4명 중 가장 처음 자원했던 저에게 진행이 떠넘겨졌습니다.\n신입생 70명·재학생 30명·교수님 5분이 참석하는 행사였고, 장소 예약·식사 발주·진행 시나리오·예산 정산까지 모두 미완성 상태였습니다. 처음에는 "1학년이 이걸 어떻게 다 하지"라며 같이 그만두자는 의견이 나왔지만, 저는 신입생들에게 이미 단체방으로 일정·장소를 공지한 약속이 마음에 걸렸습니다.\n결국 남은 운영진과 매일 저녁 1시간씩 모여 역할을 나누고, 식당·강의실 담당 행정실에 직접 가서 사정을 설명하고 도움을 받아 행사를 끝까지 진행했습니다. 행사 다음 날 학과장 교수님이 운영팀 단톡방에 "약속한 것을 끝까지 해낸 1학년이 학과에 들어왔다는 게 가장 큰 수확"이라고 메시지를 남기셨습니다.\n\n[강점으로 자리잡은 과정]\n이 사건 이후 "한 번 입에 담은 약속은 결과 보고까지 책임진다"는 것이 저의 행동 기준이 되었습니다.\n2학년 학회 임원, 3학년 학과 멘토링, 4학년 대외활동 팀장 — 모든 활동에서 같은 패턴이 반복되었습니다.\n특히 중도 변수가 생겼을 때 가장 늦게까지 남아 마무리하는 모습이 학과 내에서 "그 친구한테 맡기면 끝까지 간다"는 평가로 굳어졌고, 이 평가가 다시 약속을 끝까지 지키게 만드는 책임감으로 돌아오는 선순환이 만들어졌습니다.',
        ...
        },
        {
          ...
          placeholder: '예: 가장 영향을 준 인물은 대학 2학년 때 전공 기초 과목을 가르치셨던 OOO 교수님이셨습니다.\n다른 과목 교수님들은 기말 결과(점수·발표 완성도)로 평가가 끝났는데, 그분은 매 과제 피드백 때마다 "결과가 어떻든 처음 약속한 만큼 했는가"를 먼저 물으셨습니다.\n같은 학기, 팀 프로젝트 중간 발표에서 결과는 잘 나오지 않았지만 분담을 끝까지 지킨 한 팀에게 "과정의 완결을 보여준 팀에게 박수"라고 말씀하시며 가장 높은 점수를 주신 장면이 지금도 또렷합니다. 그날 강의실을 나오면서, 1학년 신입생 환영회에서 막연하게 느꼈던 "약속을 끝까지 지킨다"는 감각이 비로소 명확한 언어를 얻었습니다.\n그 학기 이후 모든 팀 프로젝트와 활동에서 "결과 전에 약속의 완결"을 먼저 점검하는 습관이 자리잡았고, 그분의 "과정의 완결"이라는 기준이 제 가치관의 직접적인 모델이 되었습니다.',
          rows: 5, relatedWorkbooks: ['experience']
        },
        {
          id: 'q1_4',
          ...
          placeholder: '예: 대학 2학년 때 졸업 작품 팀에서 다른 팀원들이 시간이 부족하다며 후배에게 부탁한 디자인 작업을 그냥 우리 작업물에 쓰자고 했습니다.\n후배는 도움 정도로 생각한 작업이었기에, 출처를 명시하지 않으면 모르고 넘어갈 수 있는 상황이었습니다.\n팀 분위기상 반대하기 어려웠지만, "약속하지 않은 도움을 약속한 작업처럼 쓰는 것은 책임 완결이 아니다"라고 생각해 후배에게 정식 참여 여부를 물었고, 결국 공동 작업자로 함께 마무리했습니다.\n이때 처음으로 "이 가치관은 편할 때가 아니라 흔들릴 때 지키는 것"이라는 것을 알게 되었습니다.',
        ...
        },
        {
          ...
          placeholder: '예:\n[방법 1 — 다른 맥락에서 반복]\n학업: 흥미가 떨어진 부전공도 끝까지 이수해 학점·졸업 요건 완성 / 알바: 1년 계약 카페 알바를 약속한 1년 + 다음 알바생 인수인계까지 마무리 / 동아리: 학회 회장 임기 종료 후에도 후임 안착까지 2주 동행\n\n[방법 2 — 다른 사람들이 같은 말]\n학과 동기들: "쟤한테 부탁하면 결과를 본다" / 카페 알바 사장님: "그만둘 때까지 흐트러지지 않더라" / 학과 후배: "마지막 인수인계까지 챙겨주셨다"\n\n[방법 3 — 시간적 일관성]\n대1 2학기(2022): 학과 신입생 환영회 끝까지 운영 → 대2(2023): 전공 팀 프로젝트 분담 완결 → 대3(2024): 학과 멘토링 6개월 약속 완수 → 대4(2025): 대외활동 임기 마지막까지 책임 / 4년간 한 번도 중도 포기·잠적 없이 모든 약속을 마무리 보고로 종결',
          rows: 6, relatedWorkbooks: ['experience']
        },
        {
          id: 'q1_6',
          ...
          placeholder: '예:\n[STAR 경험]\nS: 대학 3학년 때 6개월짜리 학과 멘토링 프로그램에서 1학년 멘티 2명을 맡았습니다.\nT: 중간에 한 멘티가 휴학을 결정하면서 프로그램 진행이 어려워졌습니다.\nA: 휴학 결정을 막지 않되, 처음 약속한 6개월 동안은 어떤 형태로든 연결을 유지하기로 했습니다. 매월 1회 안부 메시지, 학기 시작 시 복학 준비 도움까지 약속한 기간을 끝까지 채웠습니다.\nR: 그 멘티는 다음 학기 무사히 복학했고, 1년 뒤 본인이 멘토로 지원해 같은 약속을 후배에게 했습니다.\n\n[타인의 평가]\n프로그램 담당 교수님: "휴학생까지 끝까지 챙긴 멘토는 처음"\n멘티: "선배 덕분에 학교를 떠나도 학교에서 잊혀지지 않았다"',
        ...
        },
        {
          ...
          placeholder: '예:\n[다른 자소서 항목이 있는 경우 — 한 문장]\n이 가치관은 책임지고 완결하는 업무 태도로 자연스럽게 이어집니다.\n\n[성장과정 항목만 있는 경우 — 깊게]\n약속을 끝까지 책임지는 가치관은 지원 직무인 운영기획에서 핵심 태도와 맞물립니다.\n복수 프로젝트의 일정을 한 번 잡으면 흔들림 없이 끝까지 끌고 가는 일관성,\n초기 계획에서 변경이 발생해도 약속한 결과 지점까지 가는 추진력이 운영기획의 본질과 같습니다.\n또한 귀사의 인재상 중 "결과로 책임지는 사람"은 제 가치관의 또 다른 표현이라고 생각합니다.',
      ...
      questions: [
        {
          ...
          placeholder: '예:\n[과거의 부족함]\n대학 입학 전까지 저는 의견이 다른 사람과 직접 부딪혀 본 경험이 거의 없었습니다.\n중고등학교 시절 익숙한 친구 그룹 안에서만 깊이 어울렸고, 의견이 갈리면 "내가 한 발 물러서면 되지"라며 갈등을 피하는 방식으로 관계를 유지해왔습니다.\n"낯선 사람과 의견을 조율하는 능력"은 거의 없었고, 의견 차이가 생기는 자리 자체를 피하는 경향이 있었습니다.\n\n[지금은 강점이 된 모습]\n현재는 의견이 다를 때 먼저 자리를 만들어 차이를 짚고 가는 사람으로 평가받습니다.\n학회·동아리·인턴십에서 "갈등이 생기면 OO에게 먼저 말한다"는 위치가 되었고,\n"의견 조율은 피해야 할 문제가 아니라 함께 일하는 방식"이라는 것이 자리잡힌 가치관이 되었습니다.\n→ 가지고 있지 않았던 강점·가치관이 4년에 걸쳐 만들어진 사례입니다.',
          rows: 8, relatedWorkbooks: ['experience']
        },
        {
          id: 'q2_2',
          ...
          placeholder: '예:\n[결정적 계기 — 외부 자극]\n대학 2학년 1학기 학회 임원 활동 중, 학기 운영 방향을 두고 다른 임원 한 명과 일주일간 대립한 사건이 결정적인 출발점이었습니다.\n저는 평소처럼 "내가 한 발 물러서고 끝내자"고 생각했지만, 그 임원이 계속 의견을 가져오면서 피할 수 없는 자리에 놓였습니다.\n결국 회장 선배가 두 사람을 따로 불러 "둘 다 학회에 필요한 의견인데, 부딪혀야 할 자리를 피하기만 하면 다음에 더 큰 일에서 무너진다"고 말씀하셨고,\n그 한마디가 갈등 회피라는 제 습관을 처음으로 직시하게 만들었습니다.\n\n[내부 결심]\n그 자리 직후 저는 그 임원에게 카페에서 두 시간 동안 의견을 정면으로 나누는 자리를 먼저 제안했습니다.\n"피해도 되는 자리"가 아니라 "함께 일하기 위해 반드시 통과해야 하는 자리"로 의견 조율을 재정의한 순간이었고, 이후 모든 협업의 기본 자세가 바뀌었습니다.',
          rows: 8, relatedWorkbooks: ['experience']
        },
        {
          id: 'q2_3',
          ...
          placeholder: '예:\n[다른 맥락 반복]\n학회(대2): 임원 간 의견 충돌 시 가장 먼저 자리 만드는 역할 / 학과 멘토링(대3): 멘티 둘이 부딪혔을 때 양쪽 입장 정리해 다시 만나게 함 / 대외활동 팀장(대4 1학기): 팀원 두 명이 결과물 방향 두고 다툰 날, 회의 직후 1:1 자리로 갈등 처리 / 인턴십(대4 2학기): 부서 간 의견 차이 회의에서 사수가 "정리 좀 도와줄래"라고 부탁할 정도로 익숙해짐\n\n[타인의 인용]\n학회 회장 선배(대2 종강): "이제 갈등을 피하지 않고 다루더라"\n학과 멘토링 담당 교수님(대3): "두 멘티 사이에서 가장 어른스럽게 자리를 만들었다"\n인턴 사수(대4): "부서 간 미팅에 같이 들어가면 마음이 놓인다"\n\n[수치·관찰]\n예전: 의견이 다를 때 평균 회피 기간 2주 → 결국 자연스럽게 흐려짐\n현재: 의견 차이가 보이면 24시간 안에 자리 만들어 정리\n\n[시간 경과]\n대2 1학기 첫 사건(2023.3) → 대4 인턴십(2025.9), 약 2년 6개월 동안 4개 맥락에서 같은 패턴이 반복되었습니다.',
        ...
        },
        {
          ...
          placeholder: '예:\n[Q1 + Q2가 합쳐진 모습]\n약속을 끝까지 책임지는 사람(Q1) + 의견 차이가 생기면 먼저 자리를 만드는 사람(Q2)이 합쳐지면,\n"끝까지 가되, 가는 도중의 갈등을 회피하지 않고 다루는 사람"이 됩니다.\n이 두 축이 함께 있을 때 비로소 "신뢰받는 협업자"가 완성된다는 것을 4년의 경험으로 알게 되었습니다.\n\n[확장 방향]\n지금까지는 학과·동아리·인턴 같은 비교적 익숙한 범위에서 두 강점을 작동시켰다면,\n앞으로는 더 다양한 이해관계자(부서 간·고객·외부 파트너)와의 협업 상황으로 같은 패턴을 확장해 나가는 것이 저의 방향입니다.\n\n[5년 뒤 평가받고 싶은 한 줄]\n"이 사람과 일하면 끝까지 가는데, 가는 길이 깔끔하다."\n이 한 줄이 Q1·Q2가 함께 도달하는 모습이며, 조직에서 일하게 되더라도 동료·고객과의 관계에서 자연스럽게 이어질 것입니다.',
    ...
    1: [ // Q1 가치관 형성 심화 (5개)
      {
        ...
        placeholder: '예: 한 번 시작한 일은 흥미가 떨어져도 결과까지 갑니다.\n중간에 더 좋은 기회가 보여도 처음 약속한 사람들에게 마무리 보고를 한 다음에 옮깁니다.\n그래서 친구들과 동료들이 "쟤한테 부탁하면 결과를 본다"고 표현합니다.\n→ "책임"이라는 단어 한 번도 쓰지 않았지만 가치관이 명확하게 드러납니다.',
        rows: 5, relatedWorkbooks: ['experience']
      },
      {
        id: 'q1_d2',
        ...
        placeholder: '예:\n[시간·장소]\n대학 1학년 2학기 11월 첫 주 금요일 저녁, 학과 신입생 환영회 다음 날. 학과 사무실 앞 복도에서 학과장 교수님과 마주쳤습니다.\n\n[발언]\n교수님: "어제 행사 잘 봤어요. 1학년이 끝까지 해낸 게 가장 놀라웠어요."\n\n[표정·반응]\n평소 칭찬에 인색하시던 분이 정면으로 눈을 마주치며 한 박자 길게 말씀하셨고, 옆에 서 있던 행정 조교 선생님도 고개를 끄덕이며 "단톡방 메시지 봤어요?"라고 덧붙이셨습니다.\n\n[내 생각·행동]\n그 순간 "약속을 끝까지 지키는 것이 다른 사람에게 이렇게 보일 수 있는 일이구나"라는 생각이 처음 들었습니다. 그 직전까지는 "신입생들에게 미안해서 한다" 정도의 마음이었는데, 그 한마디로 약속의 의미가 바뀌었습니다.\n그날 저녁 노트에 "내가 끝낸 약속이 다른 사람에게도 신호가 된다"라고 적었고, 이후 모든 활동에서 이 기준을 의식하게 되었습니다.',
        rows: 10, relatedWorkbooks: ['experience']
      },
      {
        id: 'q1_d3',
        ...
        placeholder: '예: OOO 교수님의 영향을 받은 학생은 저뿐만이 아니었습니다.\n같은 수업을 들은 학과 동기 30명도 같은 말을 들었지만, 모두가 "과정의 완결"이라는 기준을 가치관으로 받아들이지는 않았습니다.\n저는 그 메시지를 특히 강하게 받아들였는데, 그 이유는 그 직전 학기 — 대학 2학년 1학기 — 에 시작했던 학회 활동을 흥미가 떨어졌다는 이유로 두 달 만에 흐지부지 그만둔 후회가 컸기 때문이었습니다.\n그 후회가 막 가시지 않은 상태에서 "과정의 완결" 메시지를 들었기 때문에, 같은 강의실의 다른 동기들보다 훨씬 깊게 새겨졌습니다.\n→ 그래서 환경의 영향만이 아니라, 그 시점의 저의 후회가 메시지를 가치관으로 굳혀놓았다고 생각합니다.',
        rows: 5, relatedWorkbooks: ['experience']
      },
      {
        id: 'q1_d4',
        ...
        placeholder: '예: 가치관이 시험받은 두 번째 순간은 대학 2학년 1학기 학회 임원으로 활동할 때였습니다.\n학회에서 진행하던 외부 강연회 준비 중 메인 강연자가 행사 3일 전 일정 취소를 통보했고, 일부 임원들이 "이번엔 그냥 취소하자, 학회 평판에 문제 없다"고 했습니다.\n저는 이미 신청자 40명에게 강연 안내를 보낸 약속이 있었기에 반대했고, 3일간 학과 교수님 두 분께 연락드려 즉석 대체 강연을 부탁드려 결국 행사를 진행했습니다. 신청자 절반은 일정이 안 맞아 못 오셨지만, 온 분들에게 "취소하지 않고 끝까지 진행해주셔서 감사하다"는 피드백을 받았습니다.\n\n세 번째 순간은 대학 4학년 졸업 작품 발표 전이었습니다. 같이 작업하던 후배가 갑작스럽게 빠졌고, 팀원 일부가 "발표만 끝나면 되니 그냥 후배 이름을 빼자"고 했지만, 공동 작업자로 끝까지 함께 가기로 한 약속을 지키기로 결정해 발표에서 후배의 역할을 정확히 명시했습니다.\n\n2학년 때는 1주일 고민했고, 4학년 때는 하루 만에 결정할 수 있었습니다.\n→ 같은 가치관이 더 빠르고 단단하게 작동하는 것이 가치관의 성숙입니다.',
        rows: 8, relatedWorkbooks: ['experience']
      },
      {
        id: 'q1_d5',
        ...
        placeholder: '예: "한 번 시작한 일은 결과까지 책임진다"는 가치관은 운영기획 직무에서 다음의 일하는 방식으로 나타납니다.\n— 프로젝트 시작 시점의 약속을 1년 뒤에도 같은 기준으로 점검하는 일관성\n— 변화가 생겨도 처음 약속한 결과 지점까지 가는 추진력\n— 마무리할 때 인수인계와 결과 보고를 끝까지 챙기는 마무리 책임\n→ 가치관 → 일하는 방식으로 자연스럽게 변환됩니다.',
    ...
    2: [ // Q2 성장 서사 심화 (6개) — "없었던 것이 만들어진 과정"의 깊이 보강
      {
        ...
        placeholder: '예: 의견 조율 능력이 부족했던 것은 단순히 성격 탓이 아니었습니다.\n중고등학교 6년간 한 동네에서 같은 친구 그룹과 어울렸고, 학원·동아리 모두 익숙한 사람들과만 깊이 일했습니다.\n갈등이 생기면 한쪽이 양보하는 것이 자연스러운 분위기였고, "내가 한 발 물러서면 되지"라는 방식이 통하는 환경이었습니다.\n같은 환경의 다른 친구들도 비슷한 패턴을 가지고 있었기에, 이 부족함을 인식할 기회조차 거의 없었습니다.\n→ 대학에 입학해 낯선 사람들과 의견을 부딪혀야 하는 상황에 놓이고서야, 이 능력이 길러질 기회가 그동안 없었다는 것을 알게 되었습니다.',
        rows: 6, relatedWorkbooks: ['experience']
      },
      {
        id: 'q2_d2',
        ...
        placeholder: '예:\n[시간·장소]\n대학 2학년 1학기 4월 셋째 주 화요일 저녁, 학회실. 임원 회의 끝나고 다른 임원들이 모두 자리를 뜬 뒤 회장 선배가 저와 다툼이 있던 임원만 남게 했습니다.\n\n[발언]\n회장 선배: "둘 다 학회에 꼭 필요한 의견이야. 부딪힐 자리를 피하기만 하면 다음 더 큰 일에서 무너진다."\n\n[표정·반응]\n평소 친근하시던 분이 정색한 표정으로 두 사람을 번갈아 보며 말씀하셨고, 옆에 앉아 있던 임원도 처음으로 저를 정면으로 쳐다봤습니다. 그 시선이 비난이 아니라 "이 자리에서 정리하자"는 신호로 느껴졌습니다.\n\n[내 생각·행동]\n그 순간 처음으로 "내가 피하기만 한 게 상대에게는 답답함이었구나"라는 생각이 들었습니다. 회의실을 나오면서 그 임원에게 "내일 카페에서 의견 차이 정리하자"고 먼저 말을 걸었고, 다음 날 두 시간 동안 정면으로 이야기를 나눴습니다.\n그날 이후 의견이 다른 자리를 피하지 않고 먼저 만드는 것이 저의 새로운 행동 기준이 되었습니다.',
        rows: 10, relatedWorkbooks: ['experience']
      },
      {
        id: 'q2_d3',
        ...
        placeholder: '예:\n[1단계 — 반복]\n학회 임원 시절(대2) 갈등 자리 만들기를 4~5회 / 학과 멘토링(대3)에서 멘티 둘 사이 자리 만들기 / 대외활동 팀원 갈등 정리 2회\n→ 같은 종류의 갈등 상황에서 같은 행동이 반복됨\n\n[2단계 — 확장]\n대외활동 팀장 시절(대4 1학기) 외부 협력 기관 담당자와 의견 차이가 생겼을 때도 똑같이 자리를 먼저 만들어 정리\n→ 처음의 학회 임원 동기와는 비교할 수 없는, 이해관계가 큰 외부 사람으로 확장됨\n\n[3단계 — 자동화]\n인턴십(대4 2학기) 첫 주, 부서 간 미팅에서 의견 차이가 보이자 의식적 결심 없이 미팅 직후 사수에게 "두 분 따로 자리 만들어볼까요"라고 자연스럽게 제안\n→ "해야겠다고 결심하는 단계"를 넘어 "자동으로 나오는 단계"에 도달',
        rows: 9, relatedWorkbooks: ['experience']
      },
      {
        id: 'q2_d4',
        ...
        placeholder: '예:\n[두 축이 함께 작동한 사례]\n대외활동 팀장 시절(대4 1학기), 외부 협력 기관과 결과물 방향을 두고 의견이 갈렸습니다.\nQ1(약속 책임 완결)만 있었다면 "처음 약속한 방향을 끝까지 밀어붙이자"가 됐을 것이고,\nQ2(의견 조율 능력)만 있었다면 "양쪽 의견을 절충해서 적당히 마무리하자"가 됐을 것입니다.\n그런데 두 축이 함께 있었기 때문에 — "처음 약속한 결과 지점은 지키되, 가는 방법은 조율하자"는 자리를 만들었고, 양측 모두 만족하는 결과로 마무리할 수 있었습니다.\n\n[주변의 평가]\n팀장 종료 회의에서 한 팀원이 "팀장님은 끝까지 가는데 가는 길에서 갈등을 잘 다뤄서 따라갈 수 있었다"고 했습니다.\n→ 두 축이 함께 있을 때 비로소 "신뢰받는 협업자"가 완성된다는 것을 한 사람이 한 줄로 표현해준 순간이었습니다.',
        rows: 8, relatedWorkbooks: ['experience']
      },
      {
        id: 'q2_d5',
        ...
        placeholder: '예:\n[내 성장 서사의 조건 확인]\n① 결정적 계기: 대2 학회 임원 시절 회장 선배의 한마디 + 다음 날 카페 미팅 제안 → 외부 자극 + 내부 결심 모두 있음\n② 자리잡은 증거: 학회·멘토링·팀장·인턴십 4개 맥락 반복(1단계) + 외부 협력 기관으로 확장(2단계) + 인턴십 첫 주 자동 제안(3단계) → 3단계 모두 충족\n③ 확장 방향: Q1(약속 책임 완결) + Q2(의견 조율) = "끝까지 가되 가는 길이 깔끔한 사람" → Q1+Q2가 자연스럽게 합쳐진 다음 단계\n\n→ 3가지 조건이 모두 충족되면 "성장 중인 강점"은 부담이 아닌 진정성의 증거가 됩니다.\n→ 채용담당자는 "완성된 사람"이 아닌 "자라고 있는 사람"을 더 신뢰합니다.',
        rows: 8, relatedWorkbooks: ['experience']
      },
      {
        id: 'q2_d6',
        ...
        placeholder: '예:\n[확인 1 — 타인에게 확인]\n학회 임원 시절을 함께 보낸 동기에게 Q2를 읽어줬더니 "맞아, 그때부터 너 진짜 달라졌어. 회장 선배 면담 직후 우리한테도 카페 미팅 제안했었잖아"라고 했습니다.\n→ 구체적 사건을 동기가 같은 기억으로 떠올렸다는 것이 진짜라는 증거입니다.\n\n[확인 3 — 흐름 점검]\n부족함(낯선 사람과 갈등 회피) → 근원(중고등 6년 익숙한 그룹 환경) → 결정적 계기(대2 학회 회장 선배 한마디 + 다음 날 카페 미팅) → 1단계 반복(학회·멘토링·팀장 4개 맥락) → 2단계 확장(외부 협력 기관) → 3단계 자동화(인턴십 첫 주) → Q1과 합쳐진 모습(끝까지 + 깔끔하게) → 확장 방향(더 다양한 이해관계자)\n→ 모든 단계가 자연스럽게 이어지면 완성입니다.',
        rows: 9, relatedWorkbooks: ['experience']
      }
    ]
  };
  ...
  const round3Questions = [
    {
      ...
      placeholder: '예: 저의 핵심 가치관은 "약속한 것은 결과까지 책임진다"는 것입니다. 대학 1학년 2학기 학과 신입생 환영회 운영팀에서 행사 일주일 전 팀장이 빠지고 나머지 운영진이 그만두자고 했을 때, 신입생들에게 이미 일정을 공지한 약속이 마음에 걸려 남은 운영진과 매일 모여 끝까지 진행해냈고, 다음 날 학과장 교수님이 "약속한 것을 끝까지 해낸 1학년"이라고 단톡방에 남기신 메시지로 책임 완결을 인생의 기준으로 삼게 되었습니다. 이 가치관은 대학 2학년 전공 기초 수업에서 늘 "과정의 완결"을 평가 기준으로 삼으셨던 OOO 교수님을 통해 명확한 언어를 얻으며 단단해졌습니다.',
      rows: 5,
    ...
    },
    {
      ...
      placeholder: '예: 대학 2학년 학회 임원 시절 강연자 일정 취소로 행사를 취소하자는 의견에 반대하고 대체 강연을 3일 만에 섭외해 약속을 지킨 순간, 그리고 4학년 졸업 작품 발표에서 후배 도움을 정식 공동 작업자로 명시한 순간이 가치관이 편할 때가 아니라 흔들릴 때 지키는 것임을 검증한 결정적 사건이었습니다. 이후에도 학업·동아리·아르바이트 모든 맥락에서 같은 모습이 반복되었고, 학과 동기·카페 알바 사장님·학과 후배가 모두 "그 사람은 한다고 한 건 어떻게든 한다"는 같은 표현을 씁니다.',
      rows: 5,
    ...
    },
    {
      ...
      placeholder: '예: 대학 3학년 학과 멘토링에서 멘티 한 명이 휴학을 결정했음에도 매월 안부 메시지와 복학 준비 도움까지 약속한 6개월을 끝까지 채워, 그 멘티가 1년 뒤 본인이 멘토로 지원해 같은 약속을 후배에게 한 것은 이 가치관이 어떻게 다음 사람에게 전달되는지를 가장 잘 보여줍니다. (옵션 — 다른 자소서 항목 없는 경우) 이 가치관은 책임 완결이 핵심 태도가 되는 운영기획 직무에서 자연스럽게 일하는 방식으로 이어집니다.',
      rows: 5,
    ...
    },
    {
      ...
      placeholder: '예: 한편 대학에 입학할 때까지 저에게는 의견이 다른 사람과 직접 부딪혀 조율하는 능력이 거의 없었습니다. 중고등 6년간 익숙한 친구 그룹 안에서만 깊이 일하며 갈등은 한쪽의 양보로 해결하는 환경에 머물렀던 영향이었습니다. 그러나 대학 2학년 학회 임원 활동 중 다른 임원과 일주일간 대립했던 자리에서 회장 선배의 "부딪힐 자리를 피하기만 하면 다음 더 큰 일에서 무너진다"는 말을 들은 직후, 다음 날 그 임원에게 카페에서 두 시간 동안 정면으로 이야기를 나눌 자리를 먼저 제안하면서, 의견 조율을 "피해야 할 문제"가 아닌 "함께 일하기 위한 자리"로 재정의한 것이 새 강점의 시작이었습니다.',
      rows: 6,
    ...
    },
    {
      ...
      placeholder: '예: 이후 학회·학과 멘토링·대외활동 팀장에서 같은 패턴이 반복되었고, 4학년 대외활동 팀장 시절에는 외부 협력 기관 담당자와의 의견 차이까지 같은 방식으로 정리했으며, 인턴십 첫 주에는 의식하지 않아도 부서 간 자리 만들기를 사수에게 자연스럽게 제안할 만큼 자리잡았습니다. 약속을 끝까지 책임지는 사람(Q1)과 의견 차이가 생기면 먼저 자리를 만드는 사람(Q2)이 합쳐진 "끝까지 가되 가는 길이 깔끔한 사람"이 저의 방향이며, 조직에서 일하게 된다면 더 다양한 이해관계자와의 협업으로 자연스럽게 확장될 것입니다.',
      rows: 6,
  ...
  const goToNextStep = () => {
    ...
    else if (currentPhase === 'round3') { if (currentStep < round3Questions.length - 1) setCurrentStep(s => s + 1); else { setFinalText(prev => (prev && prev.trim()) ? prev : generateFinalText()); setCurrentPhase('completed'); } }
    window.scrollTo(0, 0);
  };
