...
export function getImportableItems(master, workbookKey) {
  ...
  const usesExperience = [
    ...
    'personality', 'goalachievement', 'formative_experiences', 'self_introduction',
  ...
  if (workbookKey === 'interview_new' || workbookKey === 'interview_career') {
    ['motivation', 'jobcompetency', 'personality', 'goalachievement', 'formative_experiences', 'careergoal', 'self_introduction'].forEach((k) => {
  ...
  const TITLES = {
    ...
    personality: '성격의 장단점', goalachievement: '목표수립·달성', formative_experiences: '성장과정',
