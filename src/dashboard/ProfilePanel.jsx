      ...
      {empty && (
        <div style={{
          ...
          <button
            ...
            style={{
              width: '100%', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: SPACING.sm,
              background: 'transparent', border: 'none', padding: 0, cursor: 'pointer',
              fontFamily: FONT.family, textAlign: 'left',
            }}
          >
            <span style={{ fontSize: 20, color: COLORS.ink, lineHeight: FONT.lineHeight.base, fontWeight: FONT.weight.semibold }}>
              처음 사용하시나요? — 이 순서로 진행하세요
            </span>
            <span style={{ fontSize: 16, color: COLORS.accent2, fontWeight: FONT.weight.semibold, whiteSpace: 'nowrap' }}>
              {guideOpen ? '접기 ▲' : '안내 보기 ▼'}
            </span>
          </button>
          {guideOpen && (
            <ol style={{
              ...
              {isWorkbookInVariant('career_roadmap') && (
                <li><strong>STEP 0 취업 로드맵 진단</strong> — 몇 가지 질문으로 내 준비 상태를 진단하고, 가장 보완할 단계를 알려줍니다.</li>
              )}
